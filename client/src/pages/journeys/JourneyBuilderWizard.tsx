...
export function JourneyBuilderWizard({ onClose, onSave }: JourneyBuilderWizardProps) {
  ...
  const getCategoryColor = (category: string) => {
    ...
    switch (cat) {
      ...
      case 'problem analysis': return 'bg-green-100 text-green-800';
      case 'business model': return 'bg-purple-100 text-purple-800';
      case 'competition': return 'bg-orange-100 text-orange-800';
      case 'external environment': return 'bg-teal-100 text-teal-800';
      case 'strategic position': return 'bg-pink-100 text-pink-800';
      case 'decision making': return 'bg-indigo-100 text-indigo-800';
