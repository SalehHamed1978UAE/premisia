...
import { IScheduler } from './schedulers/interfaces';
import { IResourceManager } from './resources/interfaces';
import { IOptimizer } from './optimizers/interfaces';
import { IValidator } from './validators/interfaces';
import { ITaskExtractor } from './extractors/interfaces';
...
export class ProjectPlanningOrchestrator extends EventEmitter {
  ...
  private async identifyStrategyAdjustments(
    ...
    if (budgetConstraint && schedule.totalCost > budgetConstraint.value) {
