...
import { pestleClaimsService } from './pestle-claims-service.js';
import { assumptionComparisonService } from './assumption-comparison-service.js';
import { trendSynthesisService } from './trend-synthesis-service.js';
/**
...
export class TrendAnalysisAgent {
    ...
    async analyzeTrends(understandingId) {
        ...
        try {
            ...
            const { comparisons, providers: comparisonProviders } = await assumptionComparisonService.compareWithAssumptions(understandingId, flatClaims);
            ...
            const significantComparisons = assumptionComparisonService.filterSignificantComparisons(comparisons, 0.6 // 60% confidence threshold
            );
            ...
            const synthesis = await trendSynthesisService.generateSynthesis(domain, pestleFactors, significantComparisons, telemetry);
    ...
    countClaims(pestleFactors) {
        return (pestleFactors.political.length +
...
//# sourceMappingURL=trend-analysis-agent.js.map