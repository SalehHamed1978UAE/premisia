import { encryptKMS, decryptKMS, encryptJSONKMS, decryptJSONKMS, validateKMSSetup } from './utils/kms-encryption.js';
async function testKMSEncryption() {
    ...
    try {
        ...
        const decryptedJSON = await decryptJSONKMS(encryptedJSON);
...
//# sourceMappingURL=test-kms-encryption.js.map