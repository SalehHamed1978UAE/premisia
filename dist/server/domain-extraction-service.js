...
import { strategicEntities } from '@shared/schema';
...
class DomainExtractionService {
    ...
    async extractDomain(understandingId) {
        ...
        if (understandingData.companyContext) {
            ...
            if (context.industry)
                domain.industry = context.industry;
            if (context.geography)
                domain.geography = context.geography;
            if (context.language)
                domain.language = context.language;
...
//# sourceMappingURL=domain-extraction-service.js.map