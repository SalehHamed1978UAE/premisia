...
export class JourneyValidatorService {
    ...
    async validateJourney(params) {
        ...
        // =========================================================================
        const llmAnalysis = await this.getLLMRecommendations(selectedFrameworks, Array.from(infoCollected), params.userGoal);
...
//# sourceMappingURL=journey-validator-service.js.map