...
async function findLatestCompletedSession(understandingId) {
    const latestSession = await db.query.journeySessions.findFirst({
        where: (tbl, { eq, and }) => and(eq(tbl.understandingId, understandingId), eq(tbl.status, 'completed')),
 ...
 */
export async function buildStrategicSummary(understandingId) {
...
//# sourceMappingURL=strategic-summary-builder.js.map