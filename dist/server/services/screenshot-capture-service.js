...
export class ScreenshotCaptureService {
    ...
    async captureStepScreenshots(options) {
        const { journeyType, versionNumber, steps, adminSessionCookie, baseUrl = this.baseUrl, outputDir = this.outputDir, } = options;
...
//# sourceMappingURL=screenshot-capture-service.js.map