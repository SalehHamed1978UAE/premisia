...
export class PortersAnalyzer {
    ...
    async extractStakeholders(frameworkResults) {
        ...
        if (frameworkResults.threatOfNewEntrants.barriers) {
            const hasRegulatoryBarrier = frameworkResults.threatOfNewEntrants.barriers.some(b => b.toLowerCase().includes('regulat') || b.toLowerCase().includes('compliance') || b.toLowerCase().includes('license'));
    ...
    calculateAverageForceScore(frameworkResults) {
        return (frameworkResults.threatOfNewEntrants.score +
            ...
            frameworkResults.competitiveRivalry.score) / 5;
    }
...
//# sourceMappingURL=porters-analyzer.js.map