 ...
 */
import { db } from '../db';
import { journeySessions, frameworkInsights, goldenRecords } from '@shared/schema';
import { eq, sql, desc } from 'drizzle-orm';
import { initializeContext, addFrameworkResult, } from './strategic-context-accumulator';
...
import { getStrategicUnderstanding, getJourneySession, updateJourneySession } from '../services/secure-data-service';
...
export class JourneyOrchestrator {
    ...
    async executeJourney(journeySessionId, progressCallback) {
        ...
        let context = session.accumulatedContext;
        ...
        try {
            ...
            if (isJourneyRegistryV2Enabled()) {
                const journeyDef = getJourney(session.journeyType);
            ...
            await this.autoCaptureGoldenRecord(journeySessionId, session.journeyType);
...
//# sourceMappingURL=journey-orchestrator.js.map