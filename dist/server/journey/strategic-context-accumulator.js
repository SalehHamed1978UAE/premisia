 ...
 */
export function initializeContext(understanding, journeyType) {
    return {
 ...
 */
export function addFrameworkResult(context, result) {
 ...
 */
export function addMarketResearch(context, research) {
    return {
        ...context,
        marketResearch: {
            sources: [
 ...
 */
export function finalizeContext(context, decisions) {
    return {
        ...context,
        decisions,
        status: 'completed',
 ...
 */
export function synthesizeCriticalItems(context) {
    const risks = [];
    const opportunities = [];
    const constraints = [];
...
//# sourceMappingURL=strategic-context-accumulator.js.map