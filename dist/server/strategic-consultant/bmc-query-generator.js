...
export class BMCQueryGenerator {
    ...
    async generateQueriesForAllBlocks(input) {
        const [customerQueries, valueQueries, revenueQueries, channelsQueries, relationshipsQueries, resourcesQueries, activitiesQueries, partnersQueries, costQueries] = await Promise.all([
...
//# sourceMappingURL=bmc-query-generator.js.map