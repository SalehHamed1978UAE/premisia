    ...
    for (const record of result.rows) {
        try {
            ...
            if (hasUpdates) {
                ...
                await pool.query(`UPDATE strategic_entities SET ${setClause}, updated_at = NOW() WHERE id = $${values.length + 1}`, [...values, record.id]);
                encrypted++;
            }
        }
        catch (error) {
...
//# sourceMappingURL=encrypt-remaining-entities.js.map