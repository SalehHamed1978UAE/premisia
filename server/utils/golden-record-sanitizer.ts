 ...
 */
export function sanitizeRequestPayload(payload: any): any {
 ...
 */
export function sanitizeResponsePayload(payload: any): any {
  if (!payload) return null;
 ...
 */
export async function sanitizeDbSnapshot(snapshot: any): Promise<any> {
 ...
 */
export function isSensitiveDbColumn(columnName: string): boolean {
 ...
 */
export function filterSensitiveColumns(row: Record<string, any>): Record<string, any> {
 ...
 */
export function sanitizeDbRows(rows: Record<string, any>[]): Record<string, any>[] {
 ...
 */
export async function sanitizeGoldenRecordSteps(steps: any[]): Promise<any[]> {
