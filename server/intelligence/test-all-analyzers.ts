...
import type { BMCResults, PortersResults, PESTLEResults } from './types';
...
const samplePorters: PortersResults = {
  threatOfNewEntrants: {
    score: 6,
...
const samplePESTLE: PESTLEResults = {
  political: {
    trends: [
...
async function testEPMSynthesis(frameworkType: string, insights: any) {
  console.log('\n' + '='.repeat(80));
