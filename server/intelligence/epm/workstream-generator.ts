...
export class WorkstreamGenerator implements IWorkstreamGenerator {
  ...
  async generate(
    ...
    console.log('\n' + '='.repeat(80));
    console.log('[WorkstreamGenerator] 📊 GENERATING WORKSTREAMS USING WBS BUILDER');
    ...
    try {
      ...
      console.log('[WorkstreamGenerator] 📋 WBS BUILDER RESULTS:');
      console.log('─'.repeat(80));
      ...
      console.log('\n[WorkstreamGenerator] 📦 WORKSTREAMS GENERATED BY WBS:');
      ...
      console.log(`\n[WorkstreamGenerator] ✓ Successfully converted ${workstreams.length} workstreams to EPM format`);
      console.log('[WorkstreamGenerator] 📊 EPM WORKSTREAMS READY FOR INTELLIGENT PLANNING:');
